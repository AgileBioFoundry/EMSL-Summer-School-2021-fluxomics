...
# <div class="toc"><ul class="toc-item"><li><span><a href="#What-is-an-EMU-basis-vector?" data-toc-modified-id="What-is-an-EMU-basis-vector?-1"><span class="toc-item-num">1&nbsp;&nbsp;</span>What is an EMU basis vector?</a></span><ul class="toc-item"><li><span><a href="#Definitions" data-toc-modified-id="Definitions-1.1"><span class="toc-item-num">1.1&nbsp;&nbsp;</span>Definitions</a></span></li></ul></li><li><span><a href="#Yeast-metabolic-model" data-toc-modified-id="Yeast-metabolic-model-2"><span class="toc-item-num">2&nbsp;&nbsp;</span>Yeast metabolic model</a></span><ul class="toc-item"><li><span><a href="#Investigate-the-emu-subnetworks" data-toc-modified-id="Investigate-the-emu-subnetworks-2.1"><span class="toc-item-num">2.1&nbsp;&nbsp;</span>Investigate the emu subnetworks</a></span></li></ul></li><li><span><a href="#Simple-metabolic-model" data-toc-modified-id="Simple-metabolic-model-3"><span class="toc-item-num">3&nbsp;&nbsp;</span>Simple metabolic model</a></span><ul class="toc-item"><li><span><a href="#Combined-EMU-Transition-Network-of-the-Simple-metabolic-model" data-toc-modified-id="Combined-EMU-Transition-Network-of-the-Simple-metabolic-model-3.1"><span class="toc-item-num">3.1&nbsp;&nbsp;</span>Combined EMU Transition Network of the Simple metabolic model</a></span></li><li><span><a href="#Tracer-Compositions-for-Simple-EMU-network" data-toc-modified-id="Tracer-Compositions-for-Simple-EMU-network-3.2"><span class="toc-item-num">3.2&nbsp;&nbsp;</span>Tracer Compositions for Simple EMU network</a></span></li></ul></li><li><span><a href="#Extended-metabolic--model" data-toc-modified-id="Extended-metabolic--model-4"><span class="toc-item-num">4&nbsp;&nbsp;</span>Extended metabolic  model</a></span><ul class="toc-item"><li><span><a href="#Combined-EMU-transition-network--of-extended-metabolic-reaction-network" data-toc-modified-id="Combined-EMU-transition-network--of-extended-metabolic-reaction-network-4.1"><span class="toc-item-num">4.1&nbsp;&nbsp;</span>Combined EMU transition network  of extended metabolic reaction network</a></span></li><li><span><a href="#Tracer-Compositions-for-Extended-EMU-network" data-toc-modified-id="Tracer-Compositions-for-Extended-EMU-network-4.2"><span class="toc-item-num">4.2&nbsp;&nbsp;</span>Tracer Compositions for Extended EMU network</a></span></li></ul></li><li><span><a href="#TCA-Cycle-metabolic-model" data-toc-modified-id="TCA-Cycle-metabolic-model-5"><span class="toc-item-num">5&nbsp;&nbsp;</span>TCA Cycle metabolic model</a></span><ul class="toc-item"><li><span><a href="#TCA-Cycle-metabolic-reaction-network" data-toc-modified-id="TCA-Cycle-metabolic-reaction-network-5.1"><span class="toc-item-num">5.1&nbsp;&nbsp;</span>TCA Cycle metabolic reaction network</a></span></li><li><span><a href="#Combined-EMU-network-for-TCA-Cycle" data-toc-modified-id="Combined-EMU-network-for-TCA-Cycle-5.2"><span class="toc-item-num">5.2&nbsp;&nbsp;</span>Combined EMU network for TCA Cycle</a></span></li><li><span><a href="#Tracer-Compositions-for-TCA-EMU-Network" data-toc-modified-id="Tracer-Compositions-for-TCA-EMU-Network-5.3"><span class="toc-item-num">5.3&nbsp;&nbsp;</span>Tracer Compositions for TCA EMU Network</a></span></li></ul></li><li><span><a href="#Flux-observability-in-the-P.-putida-central-metabolism" data-toc-modified-id="Flux-observability-in-the-P.-putida-central-metabolism-6"><span class="toc-item-num">6&nbsp;&nbsp;</span>Flux observability in the <em>P. putida</em> central metabolism</a></span></li></ul></div>
...
cobra.io.save_json_model(emu_network[size],filename='yeast_EMU_network_size_{}.json'.format(size),
                             sort=True, pretty=True)
emu_pwys[size] =  calculate_elementary_modes( emu_network[size],verbose=True,java_args='-Xmx8g')
